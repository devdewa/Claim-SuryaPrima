...
@section('content')
<h1 class="h3 mb-2 text-gray-800">Edit Claim</h1>
             ...
             <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="tire_brand" value="{{ $claim->tire_brand }}" class="form-control mt-2" placeholder="">
                       @error('tire_brand')
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->tire_size }}" name="tire_size" placeholder="">
                        @error('tire_size')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->tire_type }}" name="tire_type" placeholder="">
                        @error('tire_type')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->no_series }}" name="no_series" placeholder="">
                        @error('no_series')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->ply_rating }}" name="ply_rating" placeholder="">
                        @error('ply_rating')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->early_flower }}" name="early_flower" placeholder="">
                        @error('early_flower')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->remaining_flower }}" name="remaining_flower" placeholder="">
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->damage }}" name="damage" placeholder="">
                        @error('damage')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->consumer_name }}" name="consumer_name" placeholder="">
                        @error('consumer_name')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->bid_industry }}" name="bid_industry" placeholder="">
                        @error('bid_industry')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->vehicle_type }}" name="vehicle_type" placeholder="">
                        @error('vehicle_type')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" value="{{ $claim->load_weight }}" name="load_weight" placeholder="">
                        @error('load_weight')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 my-2">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control mt-2" value="{{ $claim->purchase_date }}" name="purchase_date" placeholder="">
                        @error('purchase_date')
                          <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
